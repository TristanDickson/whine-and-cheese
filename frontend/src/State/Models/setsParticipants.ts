...
export const FETCH_SETS_PARTICIPANTS_SUCCESS =
  "FETCH_SETS_PARTICIPANTS_SUCCESS";
export const FETCH_SETS_PARTICIPANTS_FAILURE =
  "FETCH_SETS_PARTICIPANTS_FAILURE";
...
export const REMOVE_PARTICIPANT_FROM_SET_SUCCESS =
  "REMOVE_PARTICIPANT_FROM_SET_SUCCESS";
export const REMOVE_PARTICIPANT_FROM_SET_FAILURE =
  "REMOVE_PARTICIPANT_FROM_SET_FAILURE";

// ACTIONS
export const fetchSetsParticipants = () => ({
